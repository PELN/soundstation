  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="main_nav">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="#">DVDs</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="#">Music Cassettes</a>
        </li>
        <li class="nav-item dropdown">
          <a class="nav-link pl-0" data-toggle="dropdown" href="#"><strong>Memorabilia  <i class="fa fa-chevron-down"></i></strong></a>
          <div class="dropdown-menu">
            <a class="dropdown-item" href="#">Autographs</a>
            <a class="dropdown-item" href="#">Posters/Postcards/Artwork</a>
            <a class="dropdown-item" href="#">Record Awards</a>
          </div>
        </li>
        <li class="nav-item">
